...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.6.6", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
    ...
    a.FE.LinkRegExCommon = "(([" + c + "])|([" + c + "](\\.|-|_))){1,}[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?!^=%&amp;/~+#-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExWWW + "|" + a.FE.LinkRegExAuth + ")" + a.FE.LinkRegExEnd, a.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function(b) {
                ...
                if (k.length > 0) {
                    ...
                    try {
                        ...
                        if (i.nextSibling == k || k.nextSibling == i) {
                            ...
                            } else !t && u && u.nodeType == Node.TEXT_NODE ? (a(i).remove(), a(k).remove(), b.spaces.normalize(u), l = a(b.doc.createTextNode("\u200b")), a(u).before(l), j.setStart(u, 0),
                                j.setEnd(u, 0), o = !0) : !u && t && t.nodeType == Node.TEXT_NODE && (a(i).remove(), a(k).remove(), b.spaces.normalize(t), l = a(b.doc.createTextNode("\u200b")), a(t).after(l), j.setStart(t, t.textContent.length), j.setEnd(t, t.textContent.length), o = !0)
                        }
                        if (!o) {
                            var w, x;
        ...
        function e(a) {
            return K = [], a = a.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, function(a) {
                ...
                return K.push(a), "[FROALA.EDITOR.IFRAME " + (K.length - 1) + "]"
        ...
        function f(a) {
            return a = a.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function(a, c) {
                ...
                return b.opts.htmlRemoveTags.indexOf("iframe") >= 0 ? "" : K[parseInt(c, 10)].replace(/\&lt;/g, "<").replace(/\&gt;/g, ">")
        ...
        function r(c, d, e, f) {
            ...
            return i.push("data-fr-.*"), i.push("fr-.*"), G = new RegExp("^" + h.join("$|^") + "$", "gi"), I = new RegExp("^" + i.join("$|^") + "$", "gi"), H = new RegExp("^" + b.opts.htmlRemoveTags.join("$|^") + "$", "gi"), J = b.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)" + b.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)") + ":.+?(?=(;)|$))", "gi") : null, c = k(c, p, !0)
        }
        ...
        function i(a, d) {
            ...
            if (d && (e = "div"), e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild; i;) {
                    ...
                    else if ("BR" == i.tagName) null == g ? (g = b.doc.createElement(e), d && g.setAttribute("class", "fr-temp-div"), g.setAttribute("data-empty", !0), g.appendChild(i), f.appendChild(g)) : h === !1 && (g.appendChild(b.doc.createElement("br")), d && g.setAttribute("class", "fr-temp-div"), g.setAttribute("data-empty", !0)), g = null;
                    else {
                        var k = i.textContent;
        ...
        function B(c) {
            ...
            b.edit.on(), b.core.injectStyle(b.opts.iframeStyle),
                v(), b.opts.useClasses || (b.$el.find("[fr-original-class]").each(function() {
            ...
            if (f = d ? c : b.clean.html(c), f = f.replace(/\r|\n/g, " "), c.indexOf('class="fr-marker"') < 0 && (f = I(f)), b.core.isEmpty() && !b.opts.keepFormatOnDelete && H(f)) b.el.innerHTML = f;
                ...
                if (g) {
                    ...
                    if ((H(f) || e) && (h = b.node.deepestParent(g) || i && "LI" == i.tagName)) {
                        if ("LI" == i.tagName && (f = K(f)), g = b.markers.split(), !g) return !1;
                        g.outerHTML = f
                    } else g.outerHTML = f
        ...
        function N() {
            if (b.$wp) {
                var a = function() {
                    M(), b.placeholder && setTimeout(b.placeholder.refresh, 0)
                };
            ...
            if (b.selection.isCollapsed()) {
                ...
                b.$el.find("span[style] span[style]").each(function() {
                    if (a(this).attr("style").indexOf("font-size") >= 0) {
                        ...
                        b.attr("style").indexOf("background-color") >= 0 && (a(this).attr("style", a(this).attr("style") + ";" + b.attr("style")),
                            i(a(this), "span[style]", {}, !1))
                    }
        ...
        function d(a) {
            ...
            for (var b = "", d = c("charCodeAt"), g = c("fromCharCode"), h = m.indexOf(a[0]), i = 1; i < a.length - 2; i++) {
             ...
             if(b=='<div style="z-index: 9999;width: 100%; position: relative"><a href="https://www.froala.com/wysiwyg-editor?k=u" style="padding: 5px 10px;color: #FFF;text-decoration: none;background: #EF5350;display: block;font-size: 15px;" target="_blank">Unlicensed copy of the Froala Editor. Use it legally by purchasing a license.</a></div>')
            return "";
            return b
        }
        ...
        function j() {
            ...
            d = d || b.opts.key || [""];
            var f = o(c("ziRA1E3B9pA5B-11D-11xg1A3ZB5D1D4B-11ED2EG2pdeoC1clIH4wB-22yQD5uF4YE3E3A9=="));
            "string" == typeof d && (d = [d]), b.ul = !0;
            for (var g = 0; g < d.length; g++) {
                var j = o(d[g]) || "";
                if (!(j !== o(c(o("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) && j.indexOf(n, j.length - n.length) < 0 && [o("9qqG-7amjlwq=="), o("KA3B3C2A6D1D5H5H1A3=="), o("QzbzvxyB2yA-9m=="), o("ji1kacwmgG5bc=="), o("naamngiA3dA-16xtE-11C-9B1H-8sc==")].indexOf(n) < 0)) {
                    b.ul = !1;
                    break
                }
            }
            var l = new Image;
            b.ul === !0 ? (i(), l.src = c(o(f)) + "u") : a.FE.DT || (l.src = c(o(f)) + d.join("+")), b.events.on("contentChanged", function() {
                b.ul === !0 && h() && i()
        ...
        function g() {
            b.selection.save(), b.events.disableBlur(), r = null, t ? (t.html(""), b.browser.edge && b.opts.iframe && b.$el.append(t)) : (t = a('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%;" tabIndex="-1"></div>'), b.browser.safari ? (t.css("top", b.$sc.scrollTop()), b.$el.after(t)) : b.browser.edge && b.opts.iframe ? b.$el.append(t) : b.$box.after(t), b.events.on("destroy", function() {
                t.remove()
        ...
        function j() {
            b.browser.edge && b.opts.iframe && b.$box.after(t), b.keys.forceUndo(), u = b.snapshot.get(), null === r && (r = t.get(0).innerHTML, b.selection.restore(), b.events.enableBlur());
            ...
            c && "string" == typeof c && (r = c), (!a || a && b.events.trigger("paste.wordPaste", [r]) !== !1) && k(r, a)
        }
        ...
        function k(c, d, e) {
            ...
            if ("string" == typeof s && (c = s), "" !== c) {
                ...
                var v = t.getElementsByTagName("span");
                ...
                if (b.opts.enter == a.FE.ENTER_BR)
                    for (g = t.querySelectorAll("p, div"), f = g.length - 1; f >= 0; f--) j = g[f], 0 === j.attributes.length && (j.outerHTML = j.innerHTML + (j.nextSibling && !b.node.isEmpty(j) ? "<br>" : ""));
                else if (b.opts.enter == a.FE.ENTER_DIV)
                    for (g = t.getElementsByTagName("p"), f = g.length - 1; f >= 0; f--) j = g[f], j.outerHTML = "<div>" + j.innerHTML + "</div>";
