            ...
            switch ($proseduer_type) {
                case 'enterNumber':
                    ...
                    try {
                        ...
                        $nationalNo = $request_data['userNumber'];
                        ...
                        function dispaly_array_recursive($array_rec) {
                            if ($array_rec) {
                                //print_r($array_rec);
                                global $name;
                                 $name=$array_rec['gePersonalResult']['ANAME1'].' '
                    ...
                    $phone = substr($request_data['phone'], 1);
                    $msg =$random .' is your Maakom verification code';
                    $fields = array(
                            'mobile_number'=>'962'.$phone,
                            'msg'=>$msg,
                            'from'=>'maakom',
                            'tag'=>'3'
                    );
                ...
                case 'get_municipality_data':
                    ...
                    $arr_data['municipality']['id'] = $row['id'];
                    $arr_data['municipality']['name'] = $row['name'];
                    $arr_data['municipality']['logo'] = $row['logo'];
                    ;
                    $arr_data['municipality']['main_phone'] = $row['main_phone'];
                    $arr_data['municipality']['reports_phone'] = $row['reports_phone'];
                    $arr_data['municipality']['tenders_phone'] = $row['tenders_phone'];
                    $arr_data['municipality']['email'] = $row['email'];
                    $arr_data['municipality']['lat'] = $row['lat'];
                    $arr_data['municipality']['lng'] = $row['lng'];
                ...
                case 'userProfile':
                    ...
                    $values[1] = $request_data['user_key'];  
                    ...
                    $arr_data['id_number'] = $row['user_id_number'];
                    $arr_data['phone'] = $row['number'];
                    ;
                    $arr_data['status'] = '1';
                    echo json_encode($arr_data);
                    break;
